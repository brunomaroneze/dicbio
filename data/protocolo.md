...
- Para indicar o processo geral, usa-se "dicbio:etymologicalProcess", e as opções são "dicbio:inherited" (herdadas), "dicbio:borrowed" (empréstimos) e "dicbio:created" (neologismos morfológicos)
...
- São indicados com a classe "a ontolex:Form" e precisam conter sempre a representação escrita "ontolex:writtenRep". Podem conter também "lexinfo:gender" e "lexinfo:number".
